...
export class Deck {
  ...
  /**
   * Deals the array of playing cards in place.
   *
   * @param {PlayingCard[]} playingCards - The array of PlayingCard objects to deal.
   * @returns {PlayingCard[]} The shuffled array of PlayingCard objects.
   */
  static deal (playingCards) {
    return playingCards.splice(0, 1)[0]
  }
}
